...
namespace AKADEMINE_SYS
{
    public partial class ChangeMark : Form
    {
        ...
        public ChangeMark(string groupName, string subjectName, string studentName)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    repository.changeMark(number.ToString(), groupName, subjectName, studentName);
                    MessageBox.Show("Mark sucessfully changed!");
                    this.Close();
                }
            }
            catch(Exception exc)
